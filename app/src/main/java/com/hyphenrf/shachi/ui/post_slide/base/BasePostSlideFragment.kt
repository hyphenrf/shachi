package com.hyphenrf.shachi.ui.post_slide.base
...
import com.hyphenrf.shachi.databinding.PostSlideFragmentBinding
import com.hyphenrf.shachi.service.DownloadService
import com.hyphenrf.shachi.ui.comment.CommentFragment
            ...
            URL(fileUrl).openStream().use { input ->
                ...
                val contentUri: Uri =
                    FileProvider.getUriForFile(requireContext(),
                        "com.hyphenrf.shachi.fileprovider",
                        newFile)
                val shareIntent = Intent().apply {
                    action = Intent.ACTION_SEND
